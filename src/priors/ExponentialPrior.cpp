...
ExponentialPrior::ExponentialPrior(
    double l)
    : _lambda(l)
{}


log_double                          ExponentialPrior::getLogProb(
...
log_double                          ExponentialPrior::accountForMeanSubstChange(
    TreeAln&                 traln,
    ...
    double                   myNew) const
{
    ...
    auto   result = log_double::fromLog((myNew - myOld) *  _lambda
                                        *  blInfluence);
    return result;
}
...
double                              ExponentialPrior::getFirstDerivative(
    const AbstractParameter& param) const
{
...
ParameterContent                    ExponentialPrior::drawFromPrior(
