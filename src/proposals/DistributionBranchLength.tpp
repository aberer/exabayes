...
std::pair<BranchPlain,
          BranchPlain>DistributionBranchLength<C                    >
    ::
...
template<class C>
void DistributionBranchLength<C                                     >
    ::createProposer(
    TreeAln&             traln,
    ...
    BranchPlain          b)
{
    ...
    auto blo = BranchLengthOptimizer(traln, b, MAX_OPT_ITER,
    ...
    _proposer = optParams[0].getProposerDistribution<C>(traln,
                                                        attr._convTuner.
                                                            getParameter(),
                                                        attr._nonConvTuner.
                                                            getParameter());
    ...
    LikelihoodEvaluator& eval)
{
    ...
    auto prevAbsLen = _savedBranch.toMeanSubstitutions(
            param->getMeanSubstitutionRate());
    auto curAbsLen  = newBranch.toMeanSubstitutions(
            param->getMeanSubstitutionRate());
