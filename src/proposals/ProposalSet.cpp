...
ProposalSet&                                      ProposalSet::operator=(
    const ProposalSet&rhs)
{
...
std::vector<AbstractProposal*>                    ProposalSet::getProposalView()
const
{
...
void                                              ProposalSet::
    printVerboseAbbreviated(
    std::ostream&out,
    double       sum) const
{
    out << relativeWeight / sum * 100 <<   "%\tSET(totalNumber="
