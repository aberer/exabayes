...
LocalComm::LocalComm(
    ...
    , _mgsPerTag{}
    , _newMessages(tid2rank.size(),
        std::vector<MessageQueueSingle>(size_t(_size)))
{
    nat ctr = 0;
...
void                            LocalComm::initializeAsyncQueue(
    size_t siz,
    size_t numSlots)
{
...
int                             LocalComm::mapRealRank2Corrected(
    int rank,
    int root)
{
...
int                             LocalComm::mapCorrectedRank2Real(
    int rank,
    int root)
{
