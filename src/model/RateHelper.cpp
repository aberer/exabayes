...
std::vector<nat>                       RateHelper::extractIndices(
    nat                       num,
    nat                       numRates,
...
std::vector<double>                    RateHelper::extractSomeRates(
    nat                 num,
    nat                 numRates,
...
void                                   RateHelper::convertRelativeToLast(
...
double                                 RateHelper::convertToSum1(
    std::vector<double>&values)
{
...
void                                   RateHelper::convertToGivenSum(
    std::vector<double>&values,
    double              givenSum)
{
...
std::vector<double>                    RateHelper::getScaledValues(
    std::vector<double>values,
    double             scParameter)
{
