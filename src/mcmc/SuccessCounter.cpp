...
double                            SuccessCounter::getRatioInLastInterval()
const
{
...
void                              SuccessCounter::deserialize(
    std::istream&in)
{
...
SuccessCounter                    SuccessCounter::operator+(
