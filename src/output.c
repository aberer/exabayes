...
void chainInfoOutput(state *curstate )
{
  ...
  PRINT( "eSpr: %d/%d (%d%%) model: %d/%d (%d%%) biunif model: %d/%d (%d%%) single biunif model: %d/%d (%d%%) all biunif model: %d/%d (%d%%) ga: %d/%d (%d%%) gaExp: %d/%d (%d%%) bl: %d/%d (%d%%) blBiunif: %d/%d (%d%%) blExp: %d/%d (%d%%) \n"
