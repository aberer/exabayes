...
void                                TopologyParameter::applyParameter(
    TreeAln&               traln,
    const ParameterContent&content)
{
    ...
    for (auto&b : content.topology)
    {
        ...
        traln.clipNode(traln.getUnhookedNode(b.getPrimNode()),
                       traln.getUnhookedNode(b.getSecNode()));
    }
}


ParameterContent                    TopologyParameter::extractParameter(
