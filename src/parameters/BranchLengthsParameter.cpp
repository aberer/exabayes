...
BranchLengthsParameter::BranchLengthsParameter(nat id, nat idOfMyKind, std::vector<nat> partitions)     
...
void BranchLengthsParameter::serialize( std::ostream &out) const
{
...
double BranchLengthsParameter::getMeanSubstitutionRate() const 
{
...
void BranchLengthsParameter::updateMeanSubstRate(const TreeAln& traln)
{
  ...
  for(auto &p :_partitions)
    {
      ...
      fcs.push_back(partition.getFracChange() * partition.getPartitionContribution()); 
