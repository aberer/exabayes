...
BranchLengthOptimizer::BranchLengthOptimizer(
    TreeAln&                              traln,
...
void                    BranchLengthOptimizer::applyToTraversalDescriptor(
...
void                    BranchLengthOptimizer::optimizeBranches(
    TreeAln&traln)
{
    auto tr = &(traln.getTrHandle());
    ...
    {
        auto execModel = std::vector<bool>(traln.getNumberOfPartitions(),
                                           false);
