...
BranchLength                    GammaProposer::proposeBranch(
    BranchPlain        b,
    TreeAln&           traln,
    ...
    Randomness&        rand) const
{
    ...
    auto bl = BranchLength(b, InternalBranchLength::fromAbsolute(
                               proposedVal,
...
log_double                      GammaProposer::getLogProbability(
    double absVal) const
{
