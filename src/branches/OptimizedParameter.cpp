...
void                            OptimizedParameter::applyToMask(
...
void                            OptimizedParameter::extractDerivatives(
    TreeAln&            traln,
...
void                            OptimizedParameter::applyValues(
    double*values) const
{
    for (auto&partition : _param->getPartitions())
...
void                            OptimizedParameter::setToTypicalBranch(
