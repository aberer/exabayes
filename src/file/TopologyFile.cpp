    ...
    , hasManyTopoloFiles(_hasManyTopoloFiles)
{
    ...
    ss <<  OutputFile::getFileBaseName(workdir) << "_topologies.run-"
       << runid <<  "." << runname;
    ...
    AbstractParameter* param)
{
    ...
    auto   tp = TreePrinter(param->getCategory() == Category::BRANCH_LENGTHS,
                            false, false);
